...
angular.module('shoutoutGetSubscriberPreload').run(['$templateCache', function ($templateCache) {
  ...
  $templateCache.put('modules/widget/main.html',
    "<div class='app-container' focus-first-erroneous-field='main.showError' ng-class='[main.getStyle()[&#39;skin&#39;], main.getStyle()[&#39;layout&#39;], main.popupBackground()]' ng-if='!main.hideFormIfPopupIsOpen() &amp;&amp; !main.hideForm'>\n" +
    ...
    "</div>\n" +
    "</div>\n" +
    "<div aria-label='Subscribe' class='collectable-info' ng-class='main.getStyle()[&#39;bodyAlignment&#39;]' role='form'>\n" +
    ...
    "<input aria-label='{{main.settings.generalSettings.namePlaceholder || &#39;formFields.name.placeholder&#39; | translate}}' class='name-input info-input' ng-class='{invalid: !main.validName}' ng-model='main.subscriberName' placeholder='{{main.settings.generalSettings.namePlaceholder || &#39;formFields.name.placeholder&#39; | translate}}'>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<input aria-label='{{main.settings.generalSettings.phonePlaceholder || &#39;formFields.mobile.placeholder&#39; | translate}}' class='phone-number-input info-input' ng-class='{&#39;invalid&#39;: !main.validPhone}' ng-model='main.subscriberPhone' placeholder='{{main.settings.generalSettings.phonePlaceholder || &#39;formFields.mobile.placeholder&#39; | translate}}'>\n" +
    "</div>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "<input aria-label='{{main.settings.generalSettings.emailPlaceholder || &#39;formFields.email.placeholder&#39; | translate }}' class='email-input info-input' ng-class='{invalid: !main.validEmail}' ng-model='main.subscriberEmail' placeholder='{{main.settings.generalSettings.emailPlaceholder || &#39;formFields.email.placeholder&#39; | translate }}' type='email'>\n" +
    "</div>\n" +
    "</div>\n" +
    ...
    "</div>\n" +
    "</div>\n" +
    "<div aria-live='polite' ng-if='main.showError' ng-include='&#39;modules/widget/errors.html&#39;'></div>\n" +
    "</div>\n" +
